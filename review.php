...
<body>
	...
	<!-- Start All Pages -->
	<center> <img src="" style="background-color: red"> </center>
	<!-- End All Pages -->
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						...
						<p>Our Main Goal is Customer Satisfaction</p>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-12">
					<form  action="" method="post">
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group"> 
									<textarea class="form-control" id="message" placeholder="Review" rows="4" name="desc" data-error="" required></textarea>
									<div class="help-block with-errors"></div>
								</div>
